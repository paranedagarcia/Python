...
Se presenta un ejemplo basado en los conceptos de **envoltorios (wrappers)**, el uso de **`isinstance`** para la verificación y la gestión de excepciones de tipo **`TypeError`**.
